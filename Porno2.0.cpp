...
LRESULT CALLBACK WndProc(
   ...
   /*   PAINTSTRUCT ps;
        ...
        HBITMAP holdBMP = (HBITMAP)SelectObject(hdcMemDC, window.hBack);

        StretchBlt(hdcWindow, 0, 0, window.width, window.height, hdcMemDC, 0, 0,  bmp.bmWidth, bmp.bmHeight, SRCCOPY);
        ...
        HBITMAP hOld = (HBITMAP)SelectObject(memDC, window.hBack);

        StretchBlt(hdc, 0, 0, window.width, window.height, memDC, 0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY);
